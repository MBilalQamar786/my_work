                    ...
                    <Row className="fs-4 justify-content-center" lg={4} sm={2} xs={1}>
                        ...
                        <Col className="text-center">
                            <Row xs={1} className="justify-content-between text-white">
                                ...
                                <Col>
                                    ...
                                    <p className="fs-6 text-dark">sir Syed University of Engineering And Technology</p>
                                </Col>
                                <Col>
                                    <p className="fw-bolder fs-5 text-dark">Contact Number :-</p>
                                    <p className="fs-6 text-dark">+92 342370669</p>
                                    <p className="fw-bolder fs-5 text-dark">Emergency Number :-</p>
                                    <p className="fs-6 text-dark">+92 3361123071</p> 
                                </Col>
                            </Row>
                        ...
                        <Col className="text-center">
                            ...
                            <p className="text-dark fs-6">
                                <p className="fw-bolder fs-5">Doctor's Name :-</p> Dr.Muhammad Bilal Qamar
                                MS Ortho Surgeon
                            </p>
                            <p className="text-dark fs-6">
                                Dr.Muhammad Anas Ansari
